...
for route in [
    ...
    "app.routes.operations", "app.routes.sync_audit", "app.routes.ops_reporting", "app.routes.customer_ops",
]:
...
def serve_frontend_fallback(full_path: str):
    api_prefixes = (
        ...
        "autopublish", "wb-booking", "ops/", "operations", "analytics/", "sync-audit",
    )
