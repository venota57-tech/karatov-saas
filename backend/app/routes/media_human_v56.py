...
<header><div><h1>KARATOV Ops v5.6</h1><div class="sub">Человеческие чаты, отзывы, вопросы и медиа из ЛК маркетплейсов</div></div><div class="toolbar"><select id="platform"><option>ALL</option><option>WB</option><option>OZON</option></select><button onclick="syncMedia()">Обновить медиа из raw</button><button class="primary" onclick="loadList()">Обновить</button></div></header>
